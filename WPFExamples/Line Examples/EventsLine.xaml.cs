...
namespace ChartsTest.Line_Examples
{
    ...
    /// </summary>
    public partial class EventsLine
    {
        ...
        private void Chart_OnDataMouseDown(Chart chart, Shape sender, Point dataPoint)
        {
            MessageBox.Show("you clicked over (" + dataPoint.X + "," + dataPoint.Y + ")");
        }
    }
}
